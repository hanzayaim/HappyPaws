...
export function EditEmployeeDialog({ open, onOpenChange, user }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
...
export function DeleteEmployeeDialog({ open, onOpenChange, user }) {
  const onSubmit = (e) => {
    e.preventDefault();
    console.log("Delete shelter with ID: ", user?.id_shelter);
    onOpenChange(false);
  };
...
export function ApproveEmployeeDialog({ open, onOpenChange, user }) {
  const onSubmit = (e) => {
    e.preventDefault();
...
export function RejectEmployeeDialog({ open, onOpenChange, user }) {
  const onSubmit = (e) => {
    e.preventDefault();
...
export function ActivateEmployeeDialog({ open, onOpenChange, user }) {
  const onSubmit = (e) => {
    e.preventDefault();
...
export function DeactivateEmployeeDialog({ open, onOpenChange, user }) {
  const onSubmit = (e) => {
    e.preventDefault();

...
const adopterSchema = z.object({
    AdopterName: z.string().min(1, "Adopter name is required").refine(val => val.trim().length > 0, {
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-2 py-2">
                  <div className="grid gap-4 py-4">
                    ...
                    <Label>Phone Number</Label>
                      <Input placeholder="Adopter Type" {...register("AdopterPhoneNumber")} />
                    ...
                    <div className="flex flex-col gap-2">
                      <Input  id="picture" type="file" accept="image/*" {...register("AdopterImg")} />
                      {errors.AdopterImg && (
                        <p className="text-destructive text-sm">
